...
import me from "../assets/img/services-img-1.jpeg";
...
const AboutMe: React.FC = () => {
  ...
  const paragraphs =
    language === "IT" ? aboutMeData.paragraphs_DE : aboutMeData.paragraphs_EN;
  ...
  <article className="pl-60 max-lg:p-0">
    <img src={me} alt={me} className="max-w-[500px] h-auto" />
          </article>
          <Swiper
            spaceBetween={100}
            centeredSlides={true}
